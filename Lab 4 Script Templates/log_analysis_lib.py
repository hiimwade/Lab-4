...
def main():
    ...
    records_captures= filter_log_by_regex(log_path, r'Invalid user.*220.195.35.40', print_summary=True, print_records=True)
...
def get_file_path_from_cmd_line(param_num=1):
    ...
    # Check whether the commnad line parameter was provided
    num_params = len(sys.argv) - 1
    if num_params < param_num:
        print("Error file path not provided.")
        sys.exit()
        #Convert the file path and covert it to an absoloute path
